...
- ```01_data_preprocessing_and_description.ipynb``` covers data cleaning, variable construction, and distress proxy definition; 
- ```02_eda.ipynb``` presents the exploratory analysis;  
- ```03_modelling_and_prediction.ipynb``` contains the logistic regression, Random Forest estimation, and model evaluation.
